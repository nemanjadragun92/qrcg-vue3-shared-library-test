...
const classes = computed(() => {
  return [className, `${className}--${props.variant}`, `${className}--${props.size}`, {
    ...
    [`${className}__icon`]: hasIconPrepend || hasIconAppend,
